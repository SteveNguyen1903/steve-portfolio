...
const experiences = [
	{
		...
		points: ["Designing and creating responsive websites in accordance to SEO standard, mobile first.", "Creating website layouts and templates using Figma, Photoshop and Illustrator.", "Managing multiple Wordpress projects utilizing website tool-builder"],
	},
	{
