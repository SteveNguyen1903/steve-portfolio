	...
	return (
		<div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
			<motion.div variants={slideIn("left", "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
				...
				<div onClick={() => window.open("https://www.linkedin.com/in/steve-nguyen-1a1760248/", "_blank")} className="cursor-pointer flex flex-row gap-4 py-2">
					<FaLinkedin style={{ fontSize: "1.5em" }} />
					<p>Message me on LinkedIn!</p>
				</div>
				<a href="mailto:steve.hqn@gmail.com" className="cursor-pointer flex flex-row gap-4 py-2">
					<FaEnvelope style={{ fontSize: "1.5em" }} />
					<p>Email me at steve.hqn@gmail.com</p>
				</a>
				<a href="tel:0473865027" className="cursor-pointer flex flex-row gap-4 py-2">
